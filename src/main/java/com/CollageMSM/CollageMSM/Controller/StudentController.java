...
public class StudentController {
    ...
    public String bonafideRequest(Model model, BonafideRequest br, MultipartFile file) throws MessagingException, UnsupportedEncodingException {
        ...
        String to = stuReqSave.getEmail();
        MimeMessage message=mailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message, true);
        String maiSubject="Bonafide Certificate Tracking";
        String mailContent = "<h1>Bonafide Certificate Tracking</h1><br>"
                + "<p>Dear <strong>" + to + "</strong></p>"
                + "<p>Your bonafide certificate tracking ID is: <strong>" + stuReqSave.getId() + "</strong></p>"
                + "<p>To track the progress of your bonafide certificate, please follow the steps below:</p>"
                + "<ol>"
                + "  <li>Go to our website: <a href=\"http://localhost:8080\">Request Tracking</a></li>"
                + "  <li>Click on the \"Request Tracking\" button.</li>"
                + "  <li>Enter your tracking ID.</li>"
                + "</ol>"
                + "<p>If you have any questions or need further assistance, please don't hesitate to contact our support team at ad.developer1604@gmail.com.</p>"
                + "<p>Thank you,</p>"
    ...
    public String livingRequest(Model model, LivingRequest lr, MultipartFile file) throws MessagingException, UnsupportedEncodingException {
        String redirectPage = "index";
        ...
        if (exstingRequest.isEmpty()) {
            ...
            MimeMessage message=mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);
            String maiSubject="Leaving Certificate Tracking";
            String mailContent = "<h1>Leaving Certificate Tracking</h1><br>"
                    + "<p>Dear <strong>" + to + "</strong></p>"
                    + "<p>We have received a request to reset the password for your Innovative THings account.</p>"
                    + "<p>Your leaving certificate tracking ID is: <strong>" + stuReqSave.getId() + "</strong></p>"
                    + "<p>To track the progress of your leaving certificate, please follow the steps below:</p>"
                    + "<ol>"
                    + "  <li>Go to our website: <a href=\"http://localhost:8080\">Request Tracking</a></li>"
                    + "  <li>Click on the \"Request Tracking\" button.</li>"
                    + "  <li>Enter your tracking ID.</li>"
